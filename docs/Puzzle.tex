...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/puzzle_pieces.png}
    \caption{Dynamical Puzzle Pieces for the Basilica ($c=-1$). The contours represent the equipotential lines $G_c(z) = 2^{-n}$ for $n=0, 1, 2, 3$. The central region containing $0$ shrinks as $n$ increases. The puzzle pieces are the connected regions bounded by these curves.}
