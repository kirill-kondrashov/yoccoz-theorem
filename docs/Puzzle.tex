...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{images/puzzle_annulus.png}
    \caption{Puzzle Annulus $A_n$. The shaded region represents the set of points where the Green's function potential is between $2^{-(n+1)}$ and $2^{-n}$. This annulus separates the puzzle piece at depth $n$ from the one at depth $n+1$.}
    \label{fig:puzzle_annulus}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/para_puzzle.png}
    \caption{Para-Puzzle Pieces $\mathcal{P}_n$ in the parameter plane. The colors indicate regions where the critical point $0$ has a Green's function value less than $2^{-n}$. Note how these regions approximate the Mandelbrot set (black).}
    \label{fig:para_puzzle}
\end{figure}
