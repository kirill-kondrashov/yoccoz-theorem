...
\begin{figure}[ht]
    ...
    \caption{Dynamical Puzzle Pieces for the Basilica ($c=-1$). Left: Global view showing the filled Julia set $K(c)$ and the equipotential lines. The red box indicates the zoomed region. Right: Zoomed view around the critical point $0$. The nested contours ($G_c(z) = 1, 1/2, 1/4, \dots$) define the puzzle pieces $P_n(0)$, which shrink towards $0$.}
