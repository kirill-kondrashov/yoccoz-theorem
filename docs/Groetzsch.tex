...
\textbf{Lemma} (\texttt{groetzsch\_inequality}).
\textit{Let $S \subset \mathbb{C}$ be a domain. If $A, B \subset S$ are disjoint sets, then by the additivity and monotonicity of the integral:
