...
In this section, we establish the fundamental definitions for the dynamics of quadratic polynomials, following the standard notation (e.g., \cite{Lyubich}, \cite{Milnor}).
