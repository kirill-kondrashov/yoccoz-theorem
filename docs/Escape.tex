...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\textwidth]{images/escape_growth.png}
    \caption{Orbit Growth. Once the orbit norm exceeds $R(c)$, it grows exponentially (linear on log scale, blue). Bounded orbits fluctuate below $R(c)$ (green).}
    \label{fig:escape_growth}
\end{figure}
