...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{images/yoccoz_concept.png}
    \caption{Conceptual visualization of Yoccoz's Theorem. The nested puzzle pieces $P_0 \supset P_1 \supset P_2 \dots$ surround the critical point. If the sum of the "conformal thicknesses" (moduli) of the annuli $A_n$ is infinite, the pieces are forced to shrink to the single point $\{0\}$.}
