...
\begin{figure}[ht]
    ...
    \caption{3D view of the potential landscape. The "steps" formed by the level sets $G_c(z) = 2^{-n}$ accumulate towards the filled Julia set (where $G=0$). For non-renormalizable parameters, the geometry of these steps ensures that the puzzle pieces shrink to a point.}
    \label{fig:yoccoz_3d}
\end{figure}
